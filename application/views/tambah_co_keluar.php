  ...
  <main class="hoc container clear"> 
    <div class="sidebar one_quarter first"> 
      ...
      <ul>
          ...
          <li><a href="<?= base_url('Landing_page/co_keluar_view')?>"><b>Barang CO keluar</b></a></li>
    ...
    <div class="content three_quarter"> 
        <form action="<?php echo base_url().'landing_page/proses_co_keluar'; ?>" method="post">
			    <input type="hidden" name="id_barang" id="id_barang" value="" />
      <div class="mt-4 col-md-5">
      <select class="custom-select form-control" name="nama_co" required>
                <option value="" disabled selected>Nama Costumer</option>
                <?php foreach ($user as $row) : ?>
                  <option  class="form-control select2" value="<?php echo $row['nama_co'] ?>">  <?php echo $row['nama_co'] ?> </option>
                <?php endforeach; ?>
              </select>
            </div>
      ...
      <select class="custom-select form-control" name="kode_barang" required>
			...
			<div class="mt-4 col-md-5">
          <label>Tanggal pemesanan Costumer :</label>
			    <input class="form-control form-control-name" name="tgl_co" id="tgl_co" placeholder="tanggal" type="date" required>
			</div>
      
      <div class="mt-4 col-md-5">
			    <input class="form-control form-control-name" name="jml_co" id="jml_co" placeholder="Jumlah Order" type="text" required>
			</div>
      
									
			<div class="plan-action mt-4 col-md-5">
				<button class="btn btn-info" type="submit" value="proses_co_keluar" >Tambah Data</button>
			</div>
		</form>
