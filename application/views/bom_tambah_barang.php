...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content three_quarter"> 
        <form action="<?php echo base_url().'landing_page/proses_bom_tambah_barang'; ?>" method="post">
			    <input type="hidden" name="id_barang" id="id_barang" value="" />
			<div class="mt-4 col-md-5">
			    <input class="form-control form-control-name" name="jenis_bom" id="jenis_bom" placeholder="Jenis BOM" type="text" value="FINISH GOOD" required>
			</div>
      <div class="mt-4 col-md-5">
      ...
      <div class="mt-4 col-md-5">
				<input class="form-control form-control-name" name="no_dokumen" id="no_dokumen" placeholder="Nomer Dokumen" type="text" value="BOM-TI.00001" required>
			</div>
			<div class="mt-4 col-md-5">
      ...
      <div class="mt-4 col-md-5">
			    <input class="form-control form-control-name" name="ambil_barang" id="ambil_barang" placeholder="Jumlah" type="text" required>
			</div>
									
			<div class="plan-action mt-4 col-md-5">
				<button class="btn btn-info" type="submit" value="proses_bom_tambah_barang" >Tambah Data</button>
			</div>
		</form>
