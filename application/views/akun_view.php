  ...
  <main class="hoc container clear"> 
    <div class="sidebar one_quarter first"> 
      ...
      <nav class="sdb_holder">
        <ul>
          <li><a href="<?= base_url('Landing_page/akun_view')?>"><b>Data User</b></a></li>
    ...
    <div class="content three_quarter"> 
      ...
      <a class="btn btn-info"  href="<?php echo base_url().'register'; ?>" > 
      Tambah Data</a>
     ...
     XLS</a> -->
      <br> <br>
              ...
              <tr> 
                  ...
                  <td align=center>
                  <a class="btn btn-danger fab fa-bitbucket" href="<?= base_url()?>proses_hapus_akun/<?php echo $row['id_user']?>">
                    </a>
                  </td>
