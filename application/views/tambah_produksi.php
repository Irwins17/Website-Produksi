...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content three_quarter"> 
        <form action="<?php echo base_url().'landing_page/proses_tambah_produksi'; ?>" method="post">
			    <input type="hidden" name="id_barang" id="id_barang" value="" />
			<div class="mt-4 col-md-5">
			    <input class="form-control form-control-name" name="kode_barang" id="kode_barang" placeholder="Kode Barang" type="text" required>
			</div>
			<div class="mt-4 col-md-5">
				<input class="form-control form-control-name" name="nama_barang" id="nama_barang" placeholder="Nama Barang" type="text" required>
			</div>
      <div class="mt-4 col-md-5">
      ...
      <!-- <div class="mt-4 col-md-5">
			...
			<div class="plan-action mt-4 col-md-5">
				<button class="btn btn-info" type="submit" value="" name="proses_tambah_produksi">Tambah Data</button>
			</div>
		</form>
