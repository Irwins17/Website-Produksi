...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content three_quarter"> 
         <form action="<?php echo base_url().'landing_page/proses_edit_bom'; ?>" method="post">

										<input type="hidden" name="id_barang" id="id_barang" value="<?= $bom->id_barang?>" />
										<div class="mt-4 col-md-5">
											<input class="form-control form-control-name" name="jenis_bom" id="jenis_bom" placeholder="Jenis BOM"
												type="text" required value="<?= $bom->jenis_bom?>">
										</div>
                    <div class="mt-4 col-md-5">
											<input class="form-control form-control-name" name="kode_material" id="kode_material" placeholder="Kode Material"
												type="text" required value="<?= $bom->kode_material?>">
										</div>
                    <div class="mt-4 col-md-5">
											<input class="form-control form-control-name" name="no_dokumen" id="no_dokumen" placeholder="Nomer Dokumen"
												type="text" required value="<?= $bom->no_dokumen?>">
										</div>
                    <div class="mt-4 col-md-5">
											<input class="form-control form-control-name" name="tanggal" id="tanggal" placeholder="Tanggal"
												type="text" required value="<?= $bom->tanggal?>">
										</div>
