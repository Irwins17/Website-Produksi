...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <div class="sidebar one_quarter first"> 
      ...
      <ul>
          <li><a href="<?= base_url('Landing_page/produksi_view')?>">Stok Barang Produksi</a></li>
          <li><a href="<?= base_url('Landing_page/produksi_stok_view')?>">Tambah Stok Produksi</a></li>
          <li><a href="<?= base_url('Landing_page/produksi_sortir_view')?>"><b>Sortir Produksi</b></a></li>
    ...
    <div class="content three_quarter"> 
        <form action="<?php echo base_url().'landing_page/proses_sortir_produksi'; ?>" method="post">
      ...
      <div class="mt-4 col-md-5">
			    <input class="form-control form-control-name" name="hasil" id="hasil" placeholder="Jumlah Produk berhasil" type="text" required>
			</div>

      <div class="mt-4 col-md-5">
			    <input class="form-control form-control-name" name="reject" id="reject" placeholder="Jumlah Produk Reject" type="text" required>
			</div>
      
									
			<div class="plan-action mt-4 col-md-5">
				<button class="btn btn-info" type="submit" value="proses_sortir_produksi" >Tambah Data</button>
			</div>
		</form>
