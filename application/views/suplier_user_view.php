...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <table id="example" class="table table-striped" border="1">
      ...
      <a class="btn btn-info"  href="<?php echo base_url().'tambah_suplier_user_view'; ?>" > 
      Tambah Data</a>
      <a class="btn btn-outline-danger 	fas fa-arrow-alt-circle-down" href="<?php echo base_url().'print_user_pdf'; ?>" target="_blank"  style="margin-left: 600px;"> 
      PDF
     <a class="btn btn-outline-success 	fas fa-arrow-alt-circle-down" href="<?php echo base_url().'print_user_excel'; ?>" target="_blank"  style="padding-bottom:0px; margin-left:-140px;"> 
     XLS</a>
      <br> <br>
      </div>
              
              <tr>
                  <td><b><b>Nama Supplier</td>
                  <td><b><b>Alamat</td>
              ...
              <tr>
                  ...
                  <td align=center>
                  <a class="btn btn-success fas fa-edit" href="<?= base_url()?>edit_suplier_user/<?php echo $row['id_suplier2']?>"> 
                    </a>      | |
                  <a class="btn btn-danger fab fa-bitbucket" href="<?= base_url()?>proses_hapus_suplier_user/<?php echo $row['id_suplier2']?>">
                    </a></td>
              </tr>
          <?php endforeach; 
          ?>
