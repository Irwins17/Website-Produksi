...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <div class="sidebar one_quarter first"> 
      ...
      <nav class="sdb_holder">
        <ul>
          ...
          <li><a href="<?= base_url('Landing_page/stok_kurang_material')?>">Ambil Material</a></li>
            <!-- <ul>
    ...
    <div class="content three_quarter"> 
      ...
      <a class="btn btn-info"  href="<?php echo base_url().'landing_page/tambah_barang'; ?>" > 
      Tambah Data</a>
      <a class="btn btn-outline-danger 	fas fa-arrow-alt-circle-down" href="<?php echo base_url().'print_stok'; ?>" target="_blank"  style="margin-left: 600px;"> 
      PDF
     <a class="btn btn-outline-success 	fas fa-arrow-alt-circle-down" href="<?php echo base_url().'print_stok_excel'; ?>" target="_blank"  style="padding-bottom:0px; margin-left:-140px;"> 
     XLS</a>
      <br> <br>
      </div>
