...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <div class="sidebar one_quarter first"> 
      ...
      <ul>
          <li><a href="<?= base_url('Landing_page/suplier_view')?>">Barang Dari Supplier</a></li>
          <li><a href="<?= base_url('Landing_page/suplier_user_view')?>"><b>Tambah Suplier</b></a></li>
            <!-- <ul>
    ...
    <div class="content three_quarter"> 
        <form action="<?php echo base_url().'landing_page/proses_tambah_suplier_user_view'; ?>" method="post">
			    <input type="hidden" name="id_barang" id="id_barang" value="" />
			<!-- <div class="mt-4 col-md-5">
			    <input class="form-control form-control-name" name="kode_material" id="kode_material" placeholder="Kode Material" type="text" required>
			</div> -->
			<div class="mt-4 col-md-5">
				<input class="form-control form-control-name" name="nama_suplier" id="nama_suplier" placeholder="Nama Supplier" type="text" required>
			</div>
      <div class="mt-4 col-md-5">
				<input class="form-control form-control-name" name="alamat" id="alamat" placeholder="Alamat Supplier" type="text" required>
			</div>
      <div class="mt-4 col-md-5">
				<input class="form-control form-control-name" name="no_telp" id="no_telp" placeholder="Nomer Telpon" type="text" required>
			</div>
      <!-- <div class="mt-4 col-md-5">
     
				<label>Pilih kategori :</label>

        <select name="kategori" id="kategori" class="form-control form-control-name">
          <option value="AMDK">AMDK</option>
          <option value="Minuman RTD">Minuman RTD</option>
        </select>
			</div>
			<div class="mt-4 col-md-5">
      ...
      <div class="mt-4 col-md-5">
			    <input class="form-control form-control-name" name="total" id="jumlah" placeholder="Total" type="text" required>
			</div> -->
									
			<div class="plan-action mt-4 col-md-5">
				<button class="btn btn-info" type="submit" value="" name="proses_tambah_suplier_user_view">Tambah Data</button>
			</div>
		</form>
