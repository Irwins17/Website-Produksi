...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <div class="sidebar one_quarter first"> 
      ...
      <nav class="sdb_holder">
        <ul>
          ...
          <li><a href="<?= base_url('Landing_page/stok_material')?>"><b>Stok Material</b></a></li>
    ...
    <button class="btn btn-info btn-icon-split" data-toggle="modal" data-target="#tambah-stok" style="margin-left:45px;">
