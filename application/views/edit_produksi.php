...
<div class="wrapper bgded overlay gradient" style="background-image:url('<?=base_url()?>assets/images/demo/backgrounds/stp3.jpg');">
  <div id="breadcrumb" class="hoc clear"> 
    <h6 class="heading">Input Dari Produksi</h6>
    <ul>
      <!-- <li><a href="#">Home</a></li>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <div class="sidebar one_quarter first"> 
      ...
      <ul>
          <li><a href="<?= base_url('Landing_page/produksi_view')?>"><b>Stok Barang Produksi</b></a></li>
          <li><a href="<?= base_url('Landing_page/produksi_stok_view')?>">Tambah Stok Produksi</a></li>
          <li><a href="<?= base_url('Landing_page/produksi_sortir_view')?>">Sortir Produksi</a></li>
          </ul>
      </nav>
      
    </div>
    <div class="content three_quarter"> 
         <form action="<?php echo base_url().'landing_page/proses_edit_produksi'; ?>" method="post">

										<input type="hidden" name="id_barang" id="id_barang" value="<?= $ipb->id_barang?>" />
										<div class="mt-4 col-md-5">
											<input class="form-control form-control-name" name="kode_barang" id="kode_barang" placeholder="Kode Barang"
												type="text" required value="<?= $ipb->kode_barang?>">
										</div>
                    <div class="mt-4 col-md-5">
											<input class="form-control form-control-name" name="nama_barang" id="nama_barang" placeholder="Nama Barang"
												type="text" required value="<?= $ipb->nama_barang?>">
										</div>
                    <div class="mt-4 col-md-5">
                      <input class="form-control form-control-name" name="tanggal" id="tanggal" placeholder="Tanggal"
                       type="date" required value="<?= $ipb->tanggal?>">
                    </div>
                    <div class="mt-4 col-md-5">
                  
                      <label>Pilih Satuan :</label>

                      <select name="satuan" id="satuan" class="form-control form-control-name">
                        <option value="Karton">Karton</option>
                        <!-- <option value="Kilo Gram">Kilo Gram</option> -->
                      </select>
                    </div>
                    <div class="mt-4 col-md-5">
											<input class="form-control form-control-name" name="jumlah" id="jumlah" placeholder="Jumlah"
												type="text" required value="<?= $ipb->jumlah?>">
										</div>
                    <!-- <div class="mt-4 col-md-5">
											<input class="form-control form-control-name" name="alamat" id="alamat" placeholder="Alamat"
												type="text" required value="<?= $ipb->alamat?>">
										</div><div class="mt-4 col-md-5">
											<input class="form-control form-control-name" name="no_telp" id="no_telp" placeholder="Nomer Telpon"
												type="text" required value="<?= $ipb->no_telp?>">
										</div> -->
                   
									<div class="plan-action mt-4 pb-1 col-md-5">
										<button class="btn btn-info" type="submit" value="proses_edit_produksi" >Tambah</button>
									</div>
									</form>
