...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content three_quarter"> 
         <form action="<?php echo base_url().'landing_page/proses_edit_co'; ?>" method="post">
                    ...
                    <div class="mt-4 col-md-5">
											<input class="form-control form-control-name" name="stok_order" id="stok_order" placeholder="Stok Order"
												type="number" required value="<?= $ipb->stok_order?>" min="0">
										</div>
                    <!-- <div class="mt-4 col-md-5">
                      <input class="form-control form-control-name" name="tanggal" id="tanggal" placeholder="Tanggal"
                       type="date" required value="<?= $ipb->tanggal?>">
									...
									<div class="plan-action mt-4 pb-1 col-md-5">
										<button class="btn btn-info" type="submit" value="proses_edit_co" >Tambah</button>
									</div>
									</form>
