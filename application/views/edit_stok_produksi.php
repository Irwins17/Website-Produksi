...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content three_quarter"> 
         <form action="<?php echo base_url().'landing_page/proses_edit_stok_produksi'; ?>" method="post">
                    ...
                    <div class="mt-4 col-md-5">
									...
									<div class="plan-action mt-4 pb-1 col-md-5">
										<button class="btn btn-info" type="submit" value="proses_edit_stok_produksi" >Tambah</button>
									</div>
									</form>
