...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content three_quarter"> 
        <form action="<?php echo base_url().'landing_page/insert_data'; ?>" method="post">
			...
			<div class="mt-4 col-md-5">
				<input class="form-control form-control-name" name="nama_material" id="nama_material" placeholder="Nama Material" type="text" required>
			</div>
      <div class="mt-4 col-md-5">
      ...
      <div class="mt-4 col-md-5">
			...
			<div class="plan-action mt-4 col-md-5">
				<button class="btn btn-info" type="submit" value="" name="insert_data">Tambah Data</button>
			</div>
		</form>
