<form class="needs-validation" novalidate action="<?= site_url('kurang-stok') ?>" onsubmit="" method="post">
  <div class="modal fade" id="kurang-stok">
    <div class="modal-dialog modal-md">
      <div class="modal-content">

        <div class="modal-header">
          <h4 class="mt-2 ml-1 py-0 text">Ambil Stok Barang</h4>
