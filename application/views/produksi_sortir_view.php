...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content three_quarter"> 
      ...
      <a class="btn btn-info"  href="<?php echo base_url().'tambah_sortir_produksi'; ?>" > 
      Tambah Data</a>
      <a class="btn btn-outline-danger 	fas fa-arrow-alt-circle-down" href="<?php echo base_url().'print_sortir_pdf'; ?>" target="_blank"  style="margin-left: 600px;"> 
      PDF
     <a class="btn btn-outline-success 	fas fa-arrow-alt-circle-down" href="<?php echo base_url().'print_sortir_excel'; ?>" target="_blank"  style="padding-bottom:0px; margin-left:-140px;"> 
     XLS</a>
      <br> <br>
      </div>
              ...
              <tr>
                  ...
                  <td align=center>
                  <a class="btn btn-success fas fa-edit" href="<?= base_url()?>edit_sortir_produksi/<?= $row->id_barang?>"> 
                    </a>      | |
                  <a class="btn btn-danger fab fa-bitbucket" href="<?= base_url()?>proses_hapus_sortir_produksi/<?= $row->id_barang?>">
                    </a>
                  </td>
