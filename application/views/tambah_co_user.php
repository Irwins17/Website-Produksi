...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content three_quarter"> 
        <form action="<?php echo base_url().'landing_page/proses_tambah_co_user'; ?>" method="post">
      ...
      <select class="custom-select form-control" name="kode_barang" required>
            ...
            <div class="mt-4 col-md-5">
				<input class="form-control form-control-name" name="nama_co" id="nama_co" placeholder="Nama Customer" type="text" value="" required>
			</div>   
      <div class="mt-4 col-md-5">
				<input class="form-control form-control-name" name="alamat" id="alamat" placeholder="Alamat Customer" type="text" value="" required>
			</div>    
      ...
      <div class="mt-4 col-md-5">
			...
			<div class="plan-action mt-4 col-md-5">
				<button class="btn btn-info" type="submit" value="proses_tambah_co_user" >Tambah Data</button>
			</div>
		</form>
