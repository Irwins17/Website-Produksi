...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <div class="sidebar one_quarter first"> 
      ...
      <ul>
          <li><a href="<?= base_url('Landing_page/stokBarang')?>"><b>Data Material</b></a></li>
          <li><a href="<?= base_url('Landing_page/stok_material')?>">Stok Material</a></li>
          <li><a href="<?= base_url('Landing_page/stok_material')?>">Ambil Material</a></li>
            <!-- <ul>
    ...
    <div class="content three_quarter"> 
         <form action="<?php echo base_url().'landing_page/proses_edit_barang'; ?>" method="post">

										<input type="hidden" name="id_barang" id="id_barang" value="<?= $barang->id_barang?>" />
										<div class="mt-4 col-md-5">
											<input class="form-control form-control-name" name="kode_material" id="kode_material" placeholder="Kode Material"
												type="text" required value="<?= $barang->kode_material?>">
										</div>
										<div class="mt-4 col-md-5">
											<input class="form-control form-control-name" name="nama_material" id="nama_material" placeholder="Nama Material"
												type="text" required value="<?= $barang->nama_material?>">
										</div>
                    <div class="mt-4 col-md-5">
                      ...
                      <select name="kategori" id="kategori" class="form-control form-control-name">
                        ...
                        <option value="Minuman RTD">Minuman RTD</option>
										...
										<div class="mt-4 col-md-5">
											<input class="form-control form-control-name" name="jumlah" id="jumlah"
												placeholder="jumlah" type="text" required value="<?= $barang->jumlah?>">
										</div>
                    <div class="mt-4 col-md-5">
											<input class="form-control form-control-name" name="total" id="total"
												placeholder="Total" type="text" required value="<?= $barang->total?>">
										</div>
									
									<div class="plan-action mt-4 pb-1 col-md-5">
										<button class="btn btn-info" type="submit" value="proses_edit_barang" >Tambah</button>
									</div>
									</form>
