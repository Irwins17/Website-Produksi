...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content three_quarter"> 
         <form action="<?php echo base_url().'landing_page/proses_edit_suplier_user'; ?>" method="post">

										<input type="hidden" name="id_suplier2" id="id_suplier2" value="<?= $ipb->id_suplier2?>" />
										<div class="mt-4 col-md-5">
											<input class="form-control form-control-name" name="nama_suplier" id="nama_suplier" placeholder="Nama Suplier"
												type="text" required value="<?= $ipb->nama_suplier?>">
										</div>
                    <div class="mt-4 col-md-5">
									...
									<div class="plan-action mt-4 pb-1 col-md-5">
										<button class="btn btn-info" type="submit" value="proses_edit_suplier_user" >Tambah</button>
									</div>
									</form>
