...
<div class="wrapper row1">
  <header id="header" class="hoc clear">
    <div id="logo" class="fl_left"> 
      <h1><a href="index.html">Produksi</a></h1> 
      <img class="gambar" src="<?=base_url()?>assets/images/bulet.png" style="width:200px;" ></img>
    </div>
...
<div class="wrapper bgded overlay gradient" style="background-image:url('<?=base_url()?>assets/images/demo/backgrounds/logoipb.png');">
  ...
  <main class="hoc container clear"> 
    <div class="sidebar one_quarter first"> 
      ...
      <nav class="sdb_holder">
        <ul>
          ...
          <li><a href="#">Stok Material</a></li>
          <li><a href="#">Ambil Material</a></li>
        </ul>
      </nav>
    ...
    <div class="content three_quarter"> 
         <form action="<?php echo base_url().'landing_page/proses_edit_barang'; ?>" method="post">
										...
										<div class="mt-4">
											<input class="form-control form-control-name" name="nama_barang" id="nama_barang" placeholder="nama_barang"
												type="text" required value="<?= $barang->nama_barang?>">
										</div>
										<div class="mt-4">
											<input class="form-control form-control-name" name="jumlah" id="jumlah" placeholder="jumlah"
												type="text" required value="<?= $barang->jumlah?>">
										</div>
										<div class="mt-4">
											<input class="form-control form-control-name" name="kondisi" id="kondisi"
												placeholder="Kondisi" type="text" required value="<?= $barang->kondisi?>">
										</div>
									
									<div class="plan-action mt-4 pb-1">
										<button class="btn btn-primary" type="submit" value="proses_edit_barang" >Tambah</button>
									</div>
									</form>
