...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content three_quarter"> 
         <form action="<?php echo base_url().'landing_page/proses_edit_sortir_produksi'; ?>" method="post">

										<input type="hidden" name="id_barang" id="id_barang" value="<?= $ipb->id_barang?>" />
										<!-- <div class="mt-4 col-md-5">
											<input class="form-control form-control-name" name="brg_msk" id="brg_msk" placeholder="brg masuk"
												type="text" required value="<?= $ipb->brg_msk?>">
										</div> -->
                    <div class="mt-4 col-md-5">
									...
									<div class="plan-action mt-4 pb-1 col-md-5">
										<button class="btn btn-info" type="submit" value="proses_edit_sortir_produksi" >Tambah</button>
									</div>
									</form>
