...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <div class="sidebar one_quarter first"> 
      ...
      <nav class="sdb_holder">
        <ul>
          ...
          <li><a href="<?= base_url('Landing_page/produksi_stok_view')?>"><b>Tambah Stok Produksi</b></a></li>
    ...
    <div class="content three_quarter"> 
      ...
      <a class="btn btn-info"  href="<?php echo base_url().'tambah_stok_produksi'; ?>" > 
      Tambah Data</a>
      <a class="btn btn-outline-danger 	fas fa-arrow-alt-circle-down" href="<?php echo base_url().'print_stok_gudang_pdf'; ?>" target="_blank"  style="margin-left: 600px;"> 
      PDF
     <a class="btn btn-outline-success 	fas fa-arrow-alt-circle-down" href="<?php echo base_url().'print_stok_gudang_excel'; ?>" target="_blank"  style="padding-bottom:0px; margin-left:-140px;"> 
     XLS</a>
      <br> <br>
      </div>
              ...
              <tr>
                  ...
                  <td><b><b>Tanggal</td>
                  <td><b><b>Barang Masuk</td>
                  <td><b><b>Stok Barang</td>
                  <td><b><b>Hapus Data</td>
              ...
              <tr>
                  ...
                  <td><?= $row->jumlah ?></td>
                  <td align=center>
                  <a class="btn btn-success fas fa-edit" href="<?= base_url()?>edit_stok_produksi/<?= $row->id_barang?>"> 
                    </a>      | |
                  <a class="btn btn-danger fab fa-bitbucket" href="<?= base_url()?>proses_hapus_stok_produksi/<?= $row->id_barang?>">
                    </a>
                  </td>
